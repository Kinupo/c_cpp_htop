...
// TODO: Return the system's CPU
 Processor& System::Cpu() { 
    ...
    auto processor_status = dynamic_cast<ProcessorsStatus*>(component_status.get());
...
std::string System::Kernel() { 
    auto component_status = current_status_->Component(ComponentType::kOperatingSystem);
    auto operating_system_status = dynamic_cast<OperatingSystemStatus*>(component_status.get());
...
int System::RunningProcesses() { 
    auto component_status = current_status_->Component(ComponentType::kProcesses);
    auto processes_status = dynamic_cast<ProcessesStatus*>(component_status.get());
